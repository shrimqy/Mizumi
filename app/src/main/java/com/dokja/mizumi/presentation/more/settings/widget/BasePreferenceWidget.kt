...
import com.dokja.mizumi.presentation.more.settings.LocalPreferenceHighlighted
import com.dokja.mizumi.presentation.more.settings.LocalPreferenceMinHeight
...
internal fun Modifier.highlightBackground(highlighted: Boolean): Modifier = this.then(composed {
